    ...
    , correct_var(0)
{
    ...
    connect(ui->switch_window, &QComboBox::currentTextChanged, this, &smartcalc::change_mode);
...
void smartcalc::on_graph_clicked()
{
    if(!graphWindow) {
        ...
        disconnect(pushButton, &QPushButton::clicked, this, &smartcalc::on_push_eq_clicked);
        connect(pushButton, &QPushButton::clicked, this, &smartcalc::on_actionPlotTriggered);
    } else {
        graphWindow->close();
    }
}
...
void smartcalc::on_graphWindowClosed()
{
    if(!var) {
        ...
        disconnect(pushButton, &QPushButton::clicked, this, &smartcalc::on_actionPlotTriggered);
        connect(pushButton, &QPushButton::clicked, this, &smartcalc::on_push_eq_clicked);
...
void smartcalc::switch_buttons(QString name1, QString name2)
{
    ...
    if(!pushButton1) {
        ...
        connect(pushButton1, &QPushButton::clicked, this, &smartcalc::on_actionVarTriggered);
    }
...
void smartcalc::on_variable_clicked()
{
    if(!var) {
        ...
        connect(var, &QLineEdit::textChanged, this, &smartcalc::on_actionVarChanged);
    } else {
        disconnect(var, &QLineEdit::textChanged, this, &smartcalc::on_actionVarChanged);
...
void smartcalc::on_actionVarTriggered()
{
    add("x");
}

void smartcalc::on_push_sqrt_clicked()
{
    add("sqrt(");
}

void smartcalc::on_push_log_clicked()
{
    add("log(");
}

void smartcalc::on_push_ln_clicked()
{
    add("ln(");
}

void smartcalc::on_push_sin_clicked()
{
    add("sin(");
}

void smartcalc::on_push_cos_clicked()
{
    add("cos(");
}

void smartcalc::on_push_tan_clicked()
{
    add("tan(");
}

void smartcalc::on_push_asin_clicked()
{
    add("asin(");
}

void smartcalc::on_push_acos_clicked()
{
    add("acos(");
}

void smartcalc::on_push_atan_clicked()
{
    add("atan(");
}
...
void smartcalc::on_push_opn_brack_clicked()
{
    add("(");
}
...
void smartcalc::on_push_e_clicked()
{
    add("e");
}

void smartcalc::on_push_pi_clicked()
{
    add("P");
}
