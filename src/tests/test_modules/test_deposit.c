#include "./test_include/test_deposit.h"
...
START_TEST(deposit_by_day_1) {
  ...
  init_deposit(&data, 10000, MONTHS_PERIOD, 12, 1, 1, 2020, 15, BY_DAY,
               NOT_CAPITAL);
...
START_TEST(deposit_by_day_3) {
  ...
  init_deposit(&data, 147634.72, MONTHS_PERIOD, 17, 7, 5, 2017, 13.218, BY_DAY,
               NOT_CAPITAL);
...
START_TEST(deposit_by_day_5) {
  ...
  init_deposit(&data, 895625.37, MONTHS_PERIOD, 25, 8, 2, 1988, 12.345, BY_DAY,
               NOT_CAPITAL);
...
START_TEST(deposit_by_day_7) {
  ...
  init_deposit(&data, 7777777.77, MONTHS_PERIOD, 77, 7, 7, 1977, 7.777, BY_DAY,
               NOT_CAPITAL);
...
START_TEST(deposit_by_day_9) {
  ...
  init_deposit(&data, 326741742.86, DAYS_PERIOD, 7037, 1, 1, 2024, 16.123,
               BY_DAY, NOT_CAPITAL);
...
START_TEST(deposit_by_week_1) {
  ...
  init_deposit(&data, 10000, MONTHS_PERIOD, 12, 1, 1, 2020, 15, BY_WEEK,
               NOT_CAPITAL);
...
START_TEST(deposit_by_week_3) {
  ...
  init_deposit(&data, 147634.72, MONTHS_PERIOD, 17, 7, 5, 2017, 13.218, BY_WEEK,
               NOT_CAPITAL);
...
START_TEST(deposit_by_week_5) {
  ...
  init_deposit(&data, 895625.37, MONTHS_PERIOD, 25, 8, 2, 1988, 12.345, BY_WEEK,
               NOT_CAPITAL);
...
START_TEST(deposit_by_week_7) {
  ...
  init_deposit(&data, 7777777.77, MONTHS_PERIOD, 77, 7, 7, 1977, 7.777, BY_WEEK,
               NOT_CAPITAL);
...
START_TEST(deposit_by_week_9) {
  ...
  init_deposit(&data, 326741742.86, DAYS_PERIOD, 18037, 1, 1, 2024, 16.123,
               BY_WEEK, NOT_CAPITAL);
...
START_TEST(deposit_by_month_1) {
  ...
  init_deposit(&data, 10000, MONTHS_PERIOD, 12, 1, 1, 2020, 15, BY_MONTH,
               NOT_CAPITAL);
...
START_TEST(deposit_by_month_3) {
  ...
  init_deposit(&data, 147634.72, MONTHS_PERIOD, 17, 7, 5, 2017, 13.218,
               BY_MONTH, NOT_CAPITAL);
...
START_TEST(deposit_by_month_5) {
  ...
  init_deposit(&data, 895625.37, MONTHS_PERIOD, 25, 8, 2, 1988, 12.345,
               BY_MONTH, NOT_CAPITAL);
...
START_TEST(deposit_by_month_7) {
  ...
  init_deposit(&data, 7777777.77, MONTHS_PERIOD, 77, 7, 7, 1977, 7.777,
               BY_MONTH, NOT_CAPITAL);
...
START_TEST(deposit_by_quarter_1) {
  ...
  init_deposit(&data, 10000, MONTHS_PERIOD, 12, 1, 1, 2020, 15, BY_QUARTER,
               NOT_CAPITAL);
...
START_TEST(deposit_by_halfyear_1) {
  ...
  init_deposit(&data, 10000, MONTHS_PERIOD, 12, 1, 1, 2020, 15, BY_HALFYEAR,
               NOT_CAPITAL);
...
START_TEST(deposit_by_year_1) {
  ...
  init_deposit(&data, 10000, MONTHS_PERIOD, 12, 1, 1, 2020, 15, BY_YEAR,
               NOT_CAPITAL);
...
START_TEST(deposit_by_year_3) {
  ...
  init_deposit(&data, 147634.72, MONTHS_PERIOD, 17, 7, 5, 2017, 13.218, BY_YEAR,
               NOT_CAPITAL);
...
START_TEST(deposit_by_year_5) {
  ...
  init_deposit(&data, 895625.37, MONTHS_PERIOD, 25, 8, 2, 1988, 12.345, BY_YEAR,
               NOT_CAPITAL);
...
START_TEST(deposit_by_year_7) {
  ...
  init_deposit(&data, 7777777.77, MONTHS_PERIOD, 77, 7, 7, 1977, 7.777, BY_YEAR,
               NOT_CAPITAL);
...
START_TEST(deposit_by_end_term_1) {
  ...
  init_deposit(&data, 10000, MONTHS_PERIOD, 12, 1, 1, 2020, 15, BY_END_TERM,
               NOT_CAPITAL);
...
START_TEST(deposit_refill_by_day_1) {
  ...
  init_deposit(&data, 150000, MONTHS_PERIOD, 12, 23, 11, 2023, 15, BY_DAY,
               CAPITAL);
...
START_TEST(deposit_refill_by_day_3) {
  ...
  init_deposit(&data, 12578367.22, MONTHS_PERIOD, 52, 15, 2, 2011, 7.852,
               BY_DAY, CAPITAL);
...
START_TEST(deposit_refill_by_day_5) {
  ...
  init_deposit(&data, 102635556.23, MONTHS_PERIOD, 66, 7, 2, 2021, 5.562,
               BY_DAY, CAPITAL);
...
START_TEST(deposit_refill_by_day_7) {
  ...
  init_deposit(&data, 8737647.43, MONTHS_PERIOD, 121, 31, 1, 2015, 8.476,
               BY_DAY, CAPITAL);
...
START_TEST(deposit_refill_by_day_9) {
  ...
  init_deposit(&data, 62563535.23, MONTHS_PERIOD, 76, 22, 11, 2020, 7.851,
               BY_DAY, CAPITAL);
...
START_TEST(deposit_refill_by_week_1) {
  ...
  init_deposit(&data, 150000, MONTHS_PERIOD, 12, 23, 11, 2023, 15, BY_WEEK,
               CAPITAL);
  input_operation(&oper, 5, 1, 2024, 25000, REFILL, 0);
...
START_TEST(deposit_refill_by_month_1) {
  ...
  init_deposit(&data, 150000, MONTHS_PERIOD, 12, 23, 11, 2023, 15, BY_MONTH,
               CAPITAL);
  input_operation(&oper, 5, 1, 2024, 25000, REFILL, 0);
...
START_TEST(deposit_refill_by_quarter_1) {
  ...
  init_deposit(&data, 150000, MONTHS_PERIOD, 12, 23, 11, 2023, 15, BY_QUARTER,
               CAPITAL);
  input_operation(&oper, 5, 1, 2024, 25000, REFILL, 0);
...
START_TEST(deposit_refill_by_halfyear_1) {
  ...
  init_deposit(&data, 150000, MONTHS_PERIOD, 12, 23, 11, 2023, 15, BY_HALFYEAR,
               CAPITAL);
  input_operation(&oper, 5, 1, 2024, 25000, REFILL, 0);
...
START_TEST(deposit_refill_by_year_1) {
  ...
  init_deposit(&data, 150000, MONTHS_PERIOD, 12, 23, 11, 2023, 15, BY_YEAR,
               CAPITAL);
  input_operation(&oper, 5, 1, 2024, 25000, REFILL, 0);
...
START_TEST(deposit_refill_by_end_term_1) {
  ...
  init_deposit(&data, 150000, MONTHS_PERIOD, 12, 23, 11, 2023, 15, BY_END_TERM,
               NOT_CAPITAL);
  input_operation(&oper, 5, 1, 2024, 25000, REFILL, 0);
...
START_TEST(deposit_hardest_combined_with_taxes_1) {
  ...
  init_deposit(&data, 62563535.23, MONTHS_PERIOD, 76, 22, 11, 2024, 7.851,
               BY_MONTH, CAPITAL);
  ...
  long double taxes_total[] = {31539.52,  645439.9,  692317.11, 746005.07,
                               789538.84, 482595.78, 57065.31,  0};
...
START_TEST(deposit_hardest_combined_with_taxes_2) {
  ...
  init_deposit(&data, 12343452.12, MONTHS_PERIOD, 51, 29, 2, 2028, 11.213,
               BY_QUARTER, CAPITAL);
  ...
  long double taxes_total[] = {117705.23, 215840.09, 240191.97, 230803.86,
                               118994.26};
...
START_TEST(deposit_hardest_combined_with_taxes_3) {
  ...
  init_deposit(&data, 9999999.99, MONTHS_PERIOD, 99, 9, 9, 2029, 9.999, BY_DAY,
               CAPITAL);
  ...
  long double taxes_total[] = {13627.57,  212783.29, 251701.34,
                               280353.54, 312018.13, 347012.21,
                               322474.46, 257736.70, 281165.25};
...
START_TEST(deposit_hardest_combined_with_taxes_4) {
  ...
  init_deposit(&data, 61253378.11, MONTHS_PERIOD, 92, 21, 2, 2029, 22.311,
               BY_WEEK, CAPITAL);
  input_operation(&oper, 4, 12, 2029, 6672311, WITHDRAWALS, 0);
  input_operation(&oper, 1, 2, 2030, 42335566, REFILL, 0);
  input_operation(&oper, 7, 2, 2030, 31000000, WITHDRAWALS, 0);
  ...
  long double taxes_total[] = {1613201.00, 2576462.36, 3335798.59, 4087113.25,
                               4979624.68, 6010542.11, 7539762.38, 7581802.63};
...
START_TEST(deposit_hardest_combined_with_taxes_5) {
  ...
  init_deposit(&data, 771332.12, MONTHS_PERIOD, 56, 22, 6, 2025, 17.275,
               BY_HALFYEAR, CAPITAL);
  ...
  long double taxes_total[] = {379390.00,  826608.15,  979320.07,
                               1159635.47, 1425421.40, 206660.23};
...
Suite *deposit_withdrawals_by_week(void) {
  ...
  tcase_add_test(tc_deposit_withdrawals_by_week,
                 deposit_withdrawals_by_week_10);
...
Suite *deposit_withdrawals_by_month(void) {
  ...
  tcase_add_test(tc_deposit_withdrawals_by_month,
                 deposit_withdrawals_by_month_1);
  tcase_add_test(tc_deposit_withdrawals_by_month,
                 deposit_withdrawals_by_month_2);
  tcase_add_test(tc_deposit_withdrawals_by_month,
                 deposit_withdrawals_by_month_3);
  tcase_add_test(tc_deposit_withdrawals_by_month,
                 deposit_withdrawals_by_month_4);
  tcase_add_test(tc_deposit_withdrawals_by_month,
                 deposit_withdrawals_by_month_5);
  tcase_add_test(tc_deposit_withdrawals_by_month,
                 deposit_withdrawals_by_month_6);
  tcase_add_test(tc_deposit_withdrawals_by_month,
                 deposit_withdrawals_by_month_7);
  tcase_add_test(tc_deposit_withdrawals_by_month,
                 deposit_withdrawals_by_month_8);
  tcase_add_test(tc_deposit_withdrawals_by_month,
                 deposit_withdrawals_by_month_9);
  tcase_add_test(tc_deposit_withdrawals_by_month,
                 deposit_withdrawals_by_month_10);
...
Suite *deposit_withdrawals_by_quarter(void) {
  ...
  tcase_add_test(tc_deposit_withdrawals_by_quarter,
                 deposit_withdrawals_by_quarter_1);
  tcase_add_test(tc_deposit_withdrawals_by_quarter,
                 deposit_withdrawals_by_quarter_2);
  tcase_add_test(tc_deposit_withdrawals_by_quarter,
                 deposit_withdrawals_by_quarter_3);
  tcase_add_test(tc_deposit_withdrawals_by_quarter,
                 deposit_withdrawals_by_quarter_4);
  tcase_add_test(tc_deposit_withdrawals_by_quarter,
                 deposit_withdrawals_by_quarter_5);
  tcase_add_test(tc_deposit_withdrawals_by_quarter,
                 deposit_withdrawals_by_quarter_6);
  tcase_add_test(tc_deposit_withdrawals_by_quarter,
                 deposit_withdrawals_by_quarter_7);
  tcase_add_test(tc_deposit_withdrawals_by_quarter,
                 deposit_withdrawals_by_quarter_8);
  tcase_add_test(tc_deposit_withdrawals_by_quarter,
                 deposit_withdrawals_by_quarter_9);
  tcase_add_test(tc_deposit_withdrawals_by_quarter,
                 deposit_withdrawals_by_quarter_10);
...
Suite *deposit_withdrawals_by_halfyear(void) {
  ...
  tcase_add_test(tc_deposit_withdrawals_by_halfyear,
                 deposit_withdrawals_by_halfyear_1);
  tcase_add_test(tc_deposit_withdrawals_by_halfyear,
                 deposit_withdrawals_by_halfyear_2);
  tcase_add_test(tc_deposit_withdrawals_by_halfyear,
                 deposit_withdrawals_by_halfyear_3);
  tcase_add_test(tc_deposit_withdrawals_by_halfyear,
                 deposit_withdrawals_by_halfyear_4);
  tcase_add_test(tc_deposit_withdrawals_by_halfyear,
                 deposit_withdrawals_by_halfyear_5);
  tcase_add_test(tc_deposit_withdrawals_by_halfyear,
                 deposit_withdrawals_by_halfyear_6);
  tcase_add_test(tc_deposit_withdrawals_by_halfyear,
                 deposit_withdrawals_by_halfyear_7);
  tcase_add_test(tc_deposit_withdrawals_by_halfyear,
                 deposit_withdrawals_by_halfyear_8);
  tcase_add_test(tc_deposit_withdrawals_by_halfyear,
                 deposit_withdrawals_by_halfyear_9);
  tcase_add_test(tc_deposit_withdrawals_by_halfyear,
                 deposit_withdrawals_by_halfyear_10);
...
Suite *deposit_withdrawals_by_year(void) {
  ...
  tcase_add_test(tc_deposit_withdrawals_by_year,
                 deposit_withdrawals_by_year_10);
...
Suite *deposit_withdrawals_by_end_term(void) {
  ...
  tcase_add_test(tc_deposit_withdrawals_by_end_term,
                 deposit_withdrawals_by_end_term_1);
  tcase_add_test(tc_deposit_withdrawals_by_end_term,
                 deposit_withdrawals_by_end_term_2);
  tcase_add_test(tc_deposit_withdrawals_by_end_term,
                 deposit_withdrawals_by_end_term_3);
  tcase_add_test(tc_deposit_withdrawals_by_end_term,
                 deposit_withdrawals_by_end_term_4);
  tcase_add_test(tc_deposit_withdrawals_by_end_term,
                 deposit_withdrawals_by_end_term_5);
...
Suite *deposit_combined_with_taxes(void) {
  ...
  tcase_add_test(tc_deposit_combined_with_taxes,
                 deposit_hardest_combined_with_taxes_1);
  tcase_add_test(tc_deposit_combined_with_taxes,
                 deposit_hardest_combined_with_taxes_2);
  tcase_add_test(tc_deposit_combined_with_taxes,
                 deposit_hardest_combined_with_taxes_3);
  tcase_add_test(tc_deposit_combined_with_taxes,
                 deposit_hardest_combined_with_taxes_4);
  tcase_add_test(tc_deposit_combined_with_taxes,
                 deposit_hardest_combined_with_taxes_5);
