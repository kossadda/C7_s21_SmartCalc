...
START_TEST(arifmetic_1) {
    ...
    char *test_str = (char *)malloc((strlen(example) + 1) * sizeof(char));
    strcpy(test_str, example);
    double my_result = calculation(test_str, 0);
...
Suite *s21_smartcalc(void) {
    ...
    tcase_add_test(tc_test_trigonometric, trigonometric_1);
    tcase_add_test(tc_test_trigonometric, trigonometric_2);
    tcase_add_test(tc_test_trigonometric, trigonometric_3);
    tcase_add_test(tc_test_trigonometric, trigonometric_4);
    tcase_add_test(tc_test_trigonometric, trigonometric_5);
    tcase_add_test(tc_test_trigonometric, trigonometric_6);
    tcase_add_test(tc_test_trigonometric, trigonometric_7);
    tcase_add_test(tc_test_trigonometric, trigonometric_8);
    tcase_add_test(tc_test_trigonometric, trigonometric_9);
    tcase_add_test(tc_test_trigonometric, trigonometric_10);
    tcase_add_test(tc_test_trigonometric, trigonometric_11);
    tcase_add_test(tc_test_trigonometric, trigonometric_12);
    tcase_add_test(tc_test_trigonometric, trigonometric_13);
    tcase_add_test(tc_test_trigonometric, trigonometric_14);
    tcase_add_test(tc_test_trigonometric, trigonometric_15);
    tcase_add_test(tc_test_trigonometric, trigonometric_16);
    tcase_add_test(tc_test_trigonometric, trigonometric_17);
    tcase_add_test(tc_test_trigonometric, trigonometric_18);
    tcase_add_test(tc_test_trigonometric, trigonometric_19);
    tcase_add_test(tc_test_trigonometric, trigonometric_20);
    tcase_add_test(tc_test_trigonometric, trigonometric_21);
    tcase_add_test(tc_test_trigonometric, trigonometric_22);
    tcase_add_test(tc_test_trigonometric, trigonometric_23);
    tcase_add_test(tc_test_trigonometric, trigonometric_24);
    tcase_add_test(tc_test_trigonometric, trigonometric_25);
    tcase_add_test(tc_test_trigonometric, trigonometric_26);
    tcase_add_test(tc_test_trigonometric, trigonometric_27);
    tcase_add_test(tc_test_trigonometric, trigonometric_28);
    tcase_add_test(tc_test_trigonometric, trigonometric_29);
    tcase_add_test(tc_test_trigonometric, trigonometric_30);
    suite_add_tcase(calc, tc_test_trigonometric);

    TCase *tc_test_other = tcase_create("test_other");
    tcase_add_test(tc_test_other, other_1);
    tcase_add_test(tc_test_other, other_2);
    tcase_add_test(tc_test_other, other_3);
    tcase_add_test(tc_test_other, other_4);
    tcase_add_test(tc_test_other, other_5);
    tcase_add_test(tc_test_other, other_6);
    tcase_add_test(tc_test_other, other_7);
    tcase_add_test(tc_test_other, other_8);
    tcase_add_test(tc_test_other, other_9);
    tcase_add_test(tc_test_other, other_10);
    tcase_add_test(tc_test_other, other_11);
    tcase_add_test(tc_test_other, other_12);
    tcase_add_test(tc_test_other, other_13);
    tcase_add_test(tc_test_other, other_14);
    tcase_add_test(tc_test_other, other_15);
    tcase_add_test(tc_test_other, other_16);
    tcase_add_test(tc_test_other, other_17);
    tcase_add_test(tc_test_other, other_18);
    tcase_add_test(tc_test_other, other_19);
    tcase_add_test(tc_test_other, other_20);
    tcase_add_test(tc_test_other, other_21);
    tcase_add_test(tc_test_other, other_22);
    tcase_add_test(tc_test_other, other_23);
    tcase_add_test(tc_test_other, other_24);
    tcase_add_test(tc_test_other, other_25);
    tcase_add_test(tc_test_other, other_26);
    tcase_add_test(tc_test_other, other_27);
    tcase_add_test(tc_test_other, other_28);
    tcase_add_test(tc_test_other, other_29);
    tcase_add_test(tc_test_other, other_30);
    tcase_add_test(tc_test_other, other_31);
    tcase_add_test(tc_test_other, other_32);
    tcase_add_test(tc_test_other, other_33);
    tcase_add_test(tc_test_other, other_34);
    tcase_add_test(tc_test_other, other_35);
    tcase_add_test(tc_test_other, other_36);
    tcase_add_test(tc_test_other, other_37);
    tcase_add_test(tc_test_other, other_38);
    suite_add_tcase(calc, tc_test_other);
